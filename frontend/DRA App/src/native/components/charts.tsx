...
import { benchmarkData, C, font, perfData } from "../constants";
...
export function LineChart() {
  ...
  return (
    <Svg width="100%" height={190} viewBox={`0 0 ${width} ${height + 40}`}>
      ...
      <Polyline points={points(benchmarkData)} fill="none" stroke={C.text2} strokeWidth={2} strokeDasharray="6 6" />
      <Polyline points={points(perfData)} fill="none" stroke={C.cyan} strokeWidth={4} strokeLinecap="round" strokeLinejoin="round" />
